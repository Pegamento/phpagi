...
class AGI
{
    ...
    */
    ...
    {
        $this->asmanager = new AGI_AsteriskManager(null, $this->config['asmanager']);
...
function phpagi_error_handler($level, $message, $file, $line, $context = '')
{
    ...
    if(function_exists('mail') && !is_null($phpagi_error_handler_email)) // generate email debugging information
    {
        ...
        // TODO: find a way to get a mysqli database context to pass to the mysqli_errno functions.
        // if(strpos(' '.strtolower($message), 'mysql')) {
        //     if(function_exists('mysqli_errno')) {
        //         $db = null;
        //         $message .= 'MySQL error ' . mysqli_errno($db) . ": " . mysqli_error($db) . "\n\n";
        //     }
        // }
